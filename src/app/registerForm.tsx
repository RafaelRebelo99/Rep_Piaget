...
export default function RegisterForm() {
  return (
    <div className="min-h-screen bg-[#f4f5f7] flex flex-col">
      ...
      <main className="flex-1 flex items-start justify-center px-4 pt-6 md:pt-7">
        <section className="w-full max-w-[405px] rounded-lg bg-white px-9 py-9 shadow-[0_18px_45px_rgba(15,23,42,0.08)]">
          ...
          <form className="mt-9 space-y-6">
            <div>
              <label
                htmlFor="email"
                className="mb-2 block text-[10px] font-bold uppercase tracking-wide text-[#3c2530]"
              >
                Email
              </label>
