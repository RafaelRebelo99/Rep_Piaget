...
RF07 Os alunos devem poder fazer upload de ficheiros
Alta
(PDF, DOCX, PPTX)
RF08 Os utilizadores autenticados devem poder fazer download dos
Alta
materiais disponíveis
RF09 Os materiais devem estar organizados por disciplina e tipo (resumo,
exame, apontamento)
Alta
RF10 O sistema deve permitir a visualização de metadados do ficheiro
Média
(autor, data, disciplina)
RF11 O administrador deve poder remover materiais inadequados, Alta
RF12 O sistema deve limitar o tamanho máximo de ficheiro por upload
Média
(ex: 20 MB)

## 🔹 3.3 Feedback de Disciplinas

RF13 Os alunos devem poder submeter feedback anónimo sobre as
Alta
disciplinas
RF14 O sistema deve permitir a consulta do feedback agregado por
Alta
disciplina
RF15 Os professores devem poder visualizar o feedback da(s) sua(s)
Alta
disciplina(s)
RF16 O feedback deve incluir classificação numérica e comentário textual Média
RF17 O sistema deve impedir a submissão de múltiplos feedbacks pelo
Alta
mesmo utilizador na mesma disciplina

## 🔹 3.4 Chatbot de Apoio ao Estudo (IA)

ID Requisito Prioridade
RF18 O sistema deve disponibilizar um chatbot integrado por disciplina Alta
RF19 O chatbot deve responder a perguntas com base nos materiais
Alta
carregados na disciplina
RF20 O utilizador deve poder iniciar, continuar e terminar sessões de
Alta
estudo com o chatbot
RF21 O chatbot deve gerar quizzes automáticos com base nos materiais
Alta
da disciplina
...
RF24 O sistema deve permitir a pesquisa de materiais por nome,
Alta
disciplina e tipo
RF25 Os resultados de pesquisa devem ser filtráveis e ordenáveis Média
RF26 A pesquisa deve retornar resultados em tempo real (à medida que o
Baixa
utilizador escreve)
...
-RNF01 Desempenho As páginas devem carregar em menos de 3 segundos em
ligações normais
...
CU01 Registar conta Visitante Nenhuma
CU02 Autenticar na plataforma Aluno, Professor,
Conta registada
Admin
CU03 Fazer upload de material Aluno, Professor Autenticado
CU04 Fazer download de material Aluno, Professor Autenticado
CU05 Submeter feedback Aluno Autenticado, disciplina existente
CU06 Consultar feedback Professor, Admin Autenticado
CU07 Interagir com chatbot Aluno Autenticado, materiais
carregados
CU08 Gerar quiz Aluno Autenticado, materiais
carregados
CU09 Pesquisar conteúdos Aluno, Professor Autenticado
CU10 Gerir utilizadores Admin Autenticado como Admin
CU11 Gerir disciplinas Admin Autenticado como Admin
