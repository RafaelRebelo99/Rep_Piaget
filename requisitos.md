...
|:---|:----------|:----------:|
| RF01 | O sistema deve permitir o registo de novos utilizadores com e-mail e palavra-passe |  Alta |
| RF02 | O sistema deve permitir o login com e-mail e palavra-passe |  Alta |
| RF03 | O sistema deve suportar login com conta institucional (Google/OAuth) | Média |
...
| RF12 | O sistema deve limitar o tamanho máximo de ficheiro por upload (ex: 20 MB) |  Média |
...
| UC02 | Autenticar na plataforma | Aluno, Professor, Admin | Conta registada |
